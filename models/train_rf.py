...
import wandb
setup_wandb(project_name="Final-Project-TimeSeries-UTEC", model_type="tradicional", name="RF-temp-spec")
...
kfold_temp = kfold_trad_models([rf_model], X_temp_train, y_temp_train)
kfold_spec = kfold_trad_models([rf_model], X_spec_train, y_spec_train)
