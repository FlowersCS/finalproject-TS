...
import wandb
setup_wandb(project_name="Final-Project-TimeSeries-UTEC", model_type="tradicional", name="SVM-temp-spec")
...
#----------KFOLD-------------------
svm_model = ("SVM", SVMModel(kernel='rbf', C=1.0, probability=True))
models = [svm_model]

kfold_temp = kfold_trad_models([svm_model], X_temp_train, y_temp_train)
kfold_spec = kfold_trad_models([svm_model], X_spec_train, y_spec_train)
